...
- **多模型聚合**：6 家厂商内置——ChatGPT、Gemini、DeepSeek、Kimi、智谱清言、豆包；国内厂商统一走 OpenAI 兼容协议，模型一键切换（厂商色点胶囊）
...
正式版 APK 在 [GitHub Releases](https://github.com/sctale/TapMate/releases) 页面下载（`TapMate-v0.2.3.apk`，包名 `com.tapmate.app`）。
